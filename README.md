# Angular 20 & React 18 Examples Seo
...
* Featuring [**Angular 20.0.3**](https://github.com/angular/angular/releases) & [**Angular CLI 20.0.2**](https://github.com/angular/angular-cli/releases/)
