# Angular 15 & React 18 Examples Seo
...
* Featuring [**Angular 15.1.2**](https://github.com/angular/angular/releases) & [**Angular CLI 15.1.4**](https://github.com/angular/angular-cli/releases/)
